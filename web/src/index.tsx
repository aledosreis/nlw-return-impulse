...
import mulherfoto from './assets/page/mulher-negra-com-moletom-verde-com-as-duas-maos-no-peito.png'
import doutorFoto from './assets/page/doutor-feliz-segurando-prancheta-com-pacientes.png'
import homemFoto from './assets/page/homem-negro-com-moletom-bege-mechendo-no-celular.png'
...
export function Index() {
  ...
  function activateMenuAtCurrentSection(section : HTMLElement) {
    ...
    <>
      <nav id='navigation'>
        <div className='wrapper'>
          ...
          <div className='menu'>
            ...
            <a onClick={() => closeMenu()} className='button' href='#contact'>Agende sua consulta</a>
          ...
          <button aria-expanded='false' aria-label='Abrir menu' onClick={() => openMenu()} className='open-menu'>
          ...
          <button aria-expanded='true' aria-label='Fechar menu' onClick={() => closeMenu()} className='close-menu'>
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section id='home'>
        <div className="wrapper">
          ...
          <div className="col-b">
            <img src={mulherfoto} alt="Mulher negra vestindo moletom verde e sorrindo" />
          </div>
          <div className='stats'>
              <div className="stat">
                <h3>+3.500</h3>
      ...
      <section id="about">
        <div className="wrapper">
          ...
          <div className="col-b">
            <img src={doutorFoto} alt="Doutor feliz segurando prancheta com pacientes" />
          </div>
        </div>
      </section>
      <section id='contact'>
        <div className="wrapper">
          <div className="col-a">
            ...
            <div className="content">
              ...
              <a className='button' href="https://wa.me/5516111111111" target='_blank'>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-b">
            <img src={homemFoto} alt="Homem negro com moletom bege mechendo no celular" />
          </div>
        </div>
      </section>
      <footer>
